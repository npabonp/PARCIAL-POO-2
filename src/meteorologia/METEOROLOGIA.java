...
public class METEOROLOGIA {
    ...
    public void Registro(EstacionM es, Ciudad c, Sensor s) {
        System.out.println("Fecha" + es.getF_instalacion()
                + "Temperatura :" + s.getTemperatura()
                + "Carga Electrica : " + s.getCargaE()
                + "MMS DE AGUA LLUVIA" + s.getAgua()
